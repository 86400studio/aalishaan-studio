...
- All 58 public page entries and the connected Admin A1. [The page directory](../site-map.html) and [manifest](../site-manifest.json) define the routes. W1 is retained as historical design reference; A1 is the current Admin.
...
- Six Admin menus: Orders, Customers, Products, Support, Reports and Tools; Settings is separate. Today is the entrypoint. Preserve contextual original-record links and separate payment, fulfilment, remedy and settlement states.
